...
var Painter = function () {
  ...
  _createClass(Painter, [{
    ...
    value: function _drawQRCode(view) {
      ...
      var _preProcess2 = this._preProcess(view),
          width = _preProcess2.width,
          height = _preProcess2.height;
    ...
    value: function _drawAbsRect(view) {
      ...
      var _preProcess5 = this._preProcess(view),
